...
public class searchByGenre {
    ...
    public String searchByGenreEx(String[] inputs, Connection connection) { 
        String defaultResult = "Sorry, no results found matching what you were looking for.";
        String movieIDs = "";
        try {
        String searchMov = "select * from cinemabookingsystem.movie where ? = genre";
        String getLength = "select count(*) from cinemabookingsystem.movie where ? = genre";
